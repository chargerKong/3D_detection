    ...
    # initilize the tensor holder here.
        ...
        for j in xrange(1, len(kitti_classes)):
            ...
            if inds.numel() > 0:
                ...
                keep = torchvision.ops.nms(cls_boxes_left[order, :], cls_scores[order], cfg.TEST.NMS)
